...
1. **Commission structures vary**: some solar contractors receive payment upfront from the financing company at installation; others receive payment after inspection and utility interconnection, which can take 30–90 days.

2. **Permitting and inspection delays**: solar installations require permits and utility interconnection approval. Payment milestones often include "permission to operate" (PTO) sign-off, which can delay final payment significantly.

3. **Chargeback risk on loans**: some solar loan programs have clawback provisions if the homeowner cancels during a rescission period.

For [solar contractor financing](/solar-contractor-financing) — the working capital the solar installation business uses for its own operations between customer payment milestones — see the linked page.
