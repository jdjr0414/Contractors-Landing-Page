---
title: "How Contractors Use Receivables as Collateral"
description: Learn how contractors can use accounts receivable as collateral for financing. Understand borrowing bases, advance rates, and how receivables‑backed facilities support construction cash flow.
canonicalPath: /using-contractor-receivables-as-collateral
dateModified: 2026-03-18
h1: How Contractors Use Receivables as Collateral
intro: For many contractors, the largest asset on the balance sheet is not equipment or buildings—it is unpaid invoices. Using receivables as collateral lets you convert that locked‑up value into working capital to fund payroll, materials, and growth.
quickAnswer: Contractors can use receivables as collateral through invoice factoring, accounts receivable lines of credit, and hybrid working capital facilities. Lenders advance a percentage of eligible invoices based on customer quality, aging, and documentation, then are repaid as those invoices are collected.
...
ctaTitle: Turn receivables into working capital
ctaText: See how using invoices and pay applications as collateral can support your construction cash flow without waiting for every check to clear.
faq:
  - question: What types of receivables can contractors use as collateral?
    answer: Most facilities focus on business‑to‑business or government receivables tied to completed work—such as progress billings, pay applications, and approved change orders. Consumer receivables or very old invoices may be ineligible.
  - question: How much can I borrow against my receivables?
    answer: Advance rates vary, but contractors often see 70–90% of eligible invoice value, depending on customer quality, aging, and diversification. The total borrowing base may also be capped by overall limits and concentration rules.
  - question: Is receivables‑backed financing only for large contractors?
    answer: No. While larger firms may use complex AR lines, smaller contractors often start with simpler [invoice factoring](/invoice-factoring-contractors) that still relies on receivables as collateral.
  - question: Does using receivables as collateral hurt customer relationships?
    answer: When structured and communicated properly, it should not. Many large owners and GCs are accustomed to dealing with factors and AR lenders. Clear notices and professional handling keep relationships intact.
  - question: Can I still use bank financing if I have a receivables facility?
    answer: Yes, but lenders need to coordinate collateral so the same receivables are not pledged twice. This is usually handled through intercreditor agreements or careful structuring.
ogType: website
---
...
You can then compare options like [invoice factoring](/invoice-factoring-contractors), [accounts receivable financing](/accounts-receivable-financing-contractors), and [government receivables financing](/government-receivables-financing) to find the structure that best fits your mix of public and private work.
