---
title: "How Retainage Works in Construction: A Contractor's Guide (2026)"
description: Retainage withholds 5–10% of every draw until project completion. For subcontractors, this can mean hundreds of thousands of dollars locked up for months. Here's how retainage works and how to manage the cash flow impact.
canonicalPath: /how-contractor-retainage-works
dateModified: 2026-05-01
h1: "How Retainage Works in Construction: A Contractor's Guide (2026)"
intro: Retainage is one of the most significant — and most misunderstood — cash flow challenges in construction. If you're a subcontractor on a large commercial or public project, retainage can mean 5–10% of every dollar you earn is held until months after you finish your work. On a $2 million subcontract, that's $100,000–$200,000 in earned but unpaid money sitting with your GC or owner while you fund the next project entirely on your own.
quickAnswer: Retainage is a percentage of each construction draw (typically 5–10%) withheld by the owner or GC as security that the contractor will complete the work. It's released at substantial completion or final closeout — often 60–120 days or more after you finish your scope. The cumulative effect on subcontractor cash flow is significant, and financing tools exist specifically to bridge the retainage gap.
keyTakeaway: Retainage is a built-in cash flow drag on every construction project. Understanding when it's released, how state law affects retainage limits, and what financing options exist to bridge the wait is essential for any subcontractor working on commercial or public projects with meaningful retainage provisions.
relatedProblems: ["/contractor-cash-flow-problems", "/contractor-waiting-on-invoices", "/contractor-seasonal-cash-flow", "/contractor-retainage-financing-options"]
relatedSolutions: ["/contractor-working-capital", "/contractor-line-of-credit", "/construction-equipment-financing", "/how-contractor-financing-sales-process-works"]
ctaTitle: Explore contractor funding options
ctaText: See what working capital may be available for your business.
faq:
  - question: What percentage is typically withheld as retainage?
    answer: The standard retainage rate is 5–10% of each draw (pay application). 10% is common on public projects and on commercial projects in the early phases. 5% is common later in a project and on many private commercial contracts. Some contracts allow retainage to be reduced from 10% to 5% after a project reaches 50% completion.
  - question: When is retainage typically released to subcontractors?
    answer: Retainage is typically released after substantial completion — when the project is complete enough for the owner to occupy or use it — and after the completion of a punch list. For subcontractors, release often comes 30–90 days after your scope is complete, because the owner may hold retainage until the entire project (including other subs' work) reaches substantial completion.
  - question: Can retainage be financed?
    answer: Not directly — retainage is not a due-and-payable receivable and cannot typically be factored or used as collateral. However, contractors who are waiting on retainage can use working capital loans or lines of credit to bridge their cash flow while the retainage is held. Some specialty lenders offer retainage-specific financing products.
  - question: Do states regulate retainage amounts?
...
For many subcontractors, the answer is [working capital financing](/contractor-working-capital) that bridges the gap while retainage is held. Rather than limiting business volume based on available cash, contractors use financing to maintain operations while retainage accumulates — and repay when retainage is released.
...
**Working capital loan**: A lump-sum advance tied to your overall business revenue and cash flow, not the specific retainage amount. This is the most common approach — borrow against your business's demonstrated ability to repay, use the funds for operations, repay when retainage is released. See [working capital options for contractors](/contractor-working-capital).
...
<a href="https://axiantpartners.com/match" rel="sponsored noopener noreferrer" target="_blank">See what funding options may be available</a> to bridge your retainage gap and keep your business fully operational while project closeout plays out on someone else's schedule.
