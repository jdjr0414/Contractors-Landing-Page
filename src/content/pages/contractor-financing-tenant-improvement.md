...
1. Contractor completes a defined phase of work (or a percentage threshold)
2. Contractor prepares a draw request with supporting documentation: invoices, lien waivers, inspection certifications
3. GC assembles and submits the draw package to the tenant
4. Tenant reviews, adds their own documentation, and submits to the landlord
5. Landlord's property manager or asset management team reviews the package
6. Landlord may schedule a site inspection
7. Landlord's accounts payable processes the disbursement
8. Funds reach the tenant (or sometimes the GC directly)
9. Tenant (or GC) distributes to subcontractors
...
TI subcontractors — electrical, plumbing, HVAC, framing, drywall, painting — are at the end of this payment chain. By the time TI funds have moved from landlord to tenant to GC, the sub may be waiting 45–75 days after completing work to receive payment. This is a [cash flow problem](/contractor-cash-flow-problems) that requires active management rather than passive waiting.
...
[Working capital financing](/contractor-working-capital) is the primary tool TI contractors use to bridge the gap between costs incurred and TI disbursements received.
...
[Material purchase financing](/contractor-material-purchase-financing) is specifically useful for TI subcontractors who need to purchase materials before TI draw funds arrive.
...
For electrical subs, rough-in materials — conduit, wire, panels, boxes — can represent 40–60% of total job cost. On a $100,000 rough-in scope, that's $40,000–$60,000 in material purchases that need to be funded weeks before the first draw. See [accounts receivable financing for contractors](/accounts-receivable-financing-contractors) for how receivables can also be used to manage TI project cash flow.

The [seasonal cash flow challenges](/contractor-seasonal-cash-flow) that many TI contractors face — with project pipelines that fluctuate based on commercial leasing cycles — make a [contractor line of credit](/contractor-line-of-credit) particularly useful for TI-focused businesses. A revolving line allows you to draw when project costs hit and repay when TI funds arrive, then draw again for the next project.
...
*Direct lien rights:* Ensure your contract preserves your right to file mechanics liens on the property. Lien rights are leverage — the landlord's property is at risk — and their existence often accelerates payment even without formal lien filing. For more on this, see [all funding options](/all-funding-options) for contractors.
