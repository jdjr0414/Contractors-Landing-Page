...
relatedProblems: ["/contractor-mobilization-funding-checklist"]
...
faq:
  ...
  - question: When do contractors need funding for mobilization?
    answer: When starting a new job, materials and setup are needed before revenue arrives. The job is won, but the first payment may be weeks away. Funding bridges that gap.
  - question: What funding options help with mobilization costs?
    answer: Contractor working capital and contractor lines of credit can fund mobilization. The right option depends on whether the need is one-time or recurring.
  - question: How does mobilization funding differ from material purchase financing?
    answer: Mobilization may include materials plus equipment transport, setup, and permits. Material purchase financing focuses on supplies. Working capital can cover the full mobilization scope.
---
